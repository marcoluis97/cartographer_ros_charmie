...
options = {
  ...
  use_pose_extrapolator = false, --> this must be in case I dont have odometry
  use_odometry = true, -- get sensor_msgs/Odometry from tiago (make publisher)
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 1,
  num_multi_echo_laser_scans = 0,
  num_subdivisions_per_laser_scan = 1,
  num_point_clouds = 0, --not sure yet
...
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 1.6
